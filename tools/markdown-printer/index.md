...
|---|---|
| ![Light Mode](preview_light.png) | ![Dark Mode](preview_dark.png) |

| LLM Autocomplete | Insert Table | Image Upload |
|---|---|---|
| ![LLM Integration](llm_intergration.png) | ![Insert Table](insert_table.png) | ![Image Upload](image_upload.png) |
